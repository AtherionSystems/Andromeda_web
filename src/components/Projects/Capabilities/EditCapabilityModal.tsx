...
import { updateCapability } from "../../../api/capabilities";
...
interface Props {
  ...
  onClose: () => void;
  onSaved: (updated: Capability) => void;
}

function EditCapabilityModal({ projectId, capability, onClose, onSaved }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const updated = await updateCapability(projectId, capability.id, body);
      onSaved({ ...capability, ...updated });
      onClose();
    } catch (err) {
      setError(
